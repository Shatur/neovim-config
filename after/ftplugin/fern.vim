...
nmap <buffer><expr> H '<Plug>(fern-action-hidden-toggle)'
...
nmap <buffer><expr> U '<Plug>(fern-action-leave)<Plug>(fern-wait)<Plug>(fern-action-tcd:root)<CR>'
nmap <buffer><expr> <C-CR> '<Plug>(fern-action-enter)<Plug>(fern-wait)<Plug>(fern-action-tcd:root)<CR>'
