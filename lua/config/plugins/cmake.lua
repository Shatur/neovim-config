...
vim.api.nvim_set_keymap('', '<S-F6>', '<Cmd>Telescope cmake select_target theme=get_dropdown<CR>', { noremap = true })
...
vim.api.nvim_set_keymap('', '<S-F7>', '<Cmd>Telescope cmake select_build_type theme=get_dropdown<CR>', { noremap = true })
...
vim.api.nvim_set_keymap('', '<A-F8>', '<Cmd>CMake clean<CR>', { noremap = true })
