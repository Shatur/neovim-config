...
local config = {
  options = {
    ...
    section_separators = '',
    theme = {
      -- We are going to use lualine_c an lualine_x as left and right section. Both are highlighted by c theme.
      normal = {c = {fg = colors.fg, bg = colors.panel_border}},
      inactive = {c = {fg = colors.fg, bg = colors.panel_border}}
    }
  },
  sections = {
    -- Remove the defaults
