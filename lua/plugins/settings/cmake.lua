...
vim.api.nvim_set_keymap('n', '<S-F7>', '<Cmd>CMake select_build_type<CR>', { noremap = true })
vim.api.nvim_set_keymap('i', '<S-F7>', '<Cmd>CMake select_build_type<CR>', { noremap = true })
...
vim.api.nvim_set_keymap('n', '<S-F8>', '<Cmd>CMake select_target<CR>', { noremap = true })
vim.api.nvim_set_keymap('i', '<S-F8>', '<Cmd>CMake select_target<CR>', { noremap = true })
