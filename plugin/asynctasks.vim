...
noremap <silent> <S-F2> :AsyncTask file-open-dir<CR>
noremap <silent> <F6> :AsyncTask project-run<CR>
noremap <silent> <S-F6> :AsyncTask project-open-build<CR>
noremap <silent> <F7> :AsyncTask project-build<CR>
noremap <silent> <S-F7> :AsyncTask project-open-source<CR>
noremap <silent> <F8> :AsyncTask project-init<CR>
noremap <silent> <S-F8> :AsyncTask project-clean-build<CR>
