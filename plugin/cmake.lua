...
vim.api.nvim_set_keymap('', '<F5>', '<Cmd>write<CR><Cmd>CMake build_and_debug<CR>', { noremap = true })
vim.api.nvim_set_keymap('i', '<F5>', '<Cmd>write<CR><Cmd>CMake build_and_debug<CR>', { noremap = true })
...
vim.api.nvim_set_keymap('', '<F6>', '<Cmd>write<CR><Cmd>CMake build_and_run<CR>', { noremap = true })
vim.api.nvim_set_keymap('i', '<F6>', '<Cmd>write<CR><Cmd>CMake build_and_run<CR>', { noremap = true })
vim.api.nvim_set_keymap('', '<A-F6>', '<Cmd>CMake run<CR>', { noremap = true })
vim.api.nvim_set_keymap('i', '<A-F6>', '<Cmd>CMake run<CR>', { noremap = true })
vim.api.nvim_set_keymap('', '<F7>', '<Cmd>write<CR><Cmd>CMake build<CR>', { noremap = true })
vim.api.nvim_set_keymap('i', '<F7>', '<Cmd>write<CR><Cmd>CMake build<CR>', { noremap = true })
...
vim.api.nvim_set_keymap('', '<A-F7>', '<Cmd>write<CR><Cmd>CMake build_all<CR>', { noremap = true })
vim.api.nvim_set_keymap('i', '<A-F7>', '<Cmd>write<CR><Cmd>CMake build_all<CR>', { noremap = true })
vim.api.nvim_set_keymap('', '<F8>', '<Cmd>write<CR><Cmd>CMake configure<CR>', { noremap = true })
vim.api.nvim_set_keymap('i', '<F8>', '<Cmd>write<CR><Cmd>CMake configure<CR>', { noremap = true })
