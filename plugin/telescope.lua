...
vim.keymap.set({ '', 't', 'i' }, '<S-CR>', telescope_builtin.commands, { noremap = true, desc = 'List commands' })
vim.keymap.set({ '', 't', 'i' }, '<C-Tab>', telescope_builtin.buffers, { noremap = true, desc = 'List buffers' })
