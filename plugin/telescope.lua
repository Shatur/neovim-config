...
vim.keymap.set({ '', 't' }, '<Leader>m', telescope_builtin.keymaps, { noremap = true, desc = 'List commands' })
...
vim.keymap.set({ '', 't' }, '<Leader>q', telescope_builtin.quickfix, { noremap = true, desc = 'List quickfix items' })
